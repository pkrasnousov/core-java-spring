...
public class CoapServiceRegistryOLD {

    //=================================================================================================
    // members    
    private final Logger logger = LogManager.getLogger(CoapServiceRegistryOLD.class);
    private final AhCoapServer coapServer;
    ...
    public CoapServiceRegistryOLD(CoapServerConfiguration coapServerConfiguration, ServiceRegistryDBService serviceRegistryDBService) {
        Assert.notNull(coapServerConfiguration, "No configuration");
        Assert.notNull(serviceRegistryDBService, "No ServiceRegistryDBService");
